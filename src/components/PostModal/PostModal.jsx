  ...
  return (
    <Modal show={show} onHide={onHide}>
      ...
      <Modal.Body>
        ...
        >
          <Form.Group className="mb-3 post-text" controlId="exampleForm.ControlTextarea1">
            <Form.Control
              as="textarea"
              rows={3}
          ...
          <Form.Group>
            <UploadImage />
            <Form.Control className="d-none" id="file-input" type="file" onChange={e => setPictureFile(e.target.files[0])} />
          </Form.Group>
        </Form>
      </Modal.Body>
      <Modal.Footer>
